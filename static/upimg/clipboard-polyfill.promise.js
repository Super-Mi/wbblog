!function (root, factory) {
    ...
    return function (modules) {
        ...
        exports.setDebugLog = function (f) {
            debugLog = f
        }, exports.suppressWarnings = function () {
            showWarnings = !1, DT_1.suppressDTWarnings()
        }, exports.write = write, exports.writeText = function (s) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        function execCopy(data) {
            var tracker = new FallbackTracker, listener = function (tracker, data, e) {
        ...
        }.bind(console, "[clipboard-polyfill]"), showWarnings = !0;
        ...
        var DT = function () {
            ...
            return DT.prototype.setData = function (type, value) {
                ...
                for (var k in this.m) f(this.m[k], k)
            }, DT
        }();
        exports.DT = DT
    }, function (module, exports, __webpack_require__) {
        ...
        "use strict";
        Object.defineProperty(exports, "__esModule", {value: !0}), __webpack_require__(4), function (m) {
        ...
        (function (process, global) {
            ...
            !function (global, factory) {
                ...
                var browserWindow = "undefined" != typeof window ? window : void 0, browserGlobal = browserWindow || {},
                ...
                scheduleFlush = isNode ? function () {
                    ...
                    var iterations = 0, observer = new BrowserMutationObserver(flush),
                    ...
                    try {
                        ...
                        return void 0 !== (vertxNext = vertx.runOnLoop || vertx.runOnContext) ? function () {
                            vertxNext(flush)
                        } : useSetTimeout()
                    } catch (e) {
                ...
                var PENDING = void 0, FULFILLED = 1, REJECTED = 2, TRY_CATCH_ERROR = {error: null};

                function getThen(promise) {
                    try {
                        return promise.then
                    } catch (error) {
                        return TRY_CATCH_ERROR.error = error, TRY_CATCH_ERROR
                    }
                }
                ...
                function handleMaybeThenable(promise, maybeThenable, then$$1) {
                    ...
                    }(promise, maybeThenable) : then$$1 === TRY_CATCH_ERROR ? (reject(promise, TRY_CATCH_ERROR.error), TRY_CATCH_ERROR.error = null) : void 0 === then$$1 ? fulfill(promise, maybeThenable) : isFunction(then$$1) ? function (promise, thenable, then$$1) {
                ...
                function resolve(promise, value) {
                    promise === value ? reject(promise, new TypeError("You cannot resolve a promise with itself")) : !function (x) {
                        var type = typeof x;
                        return null !== x && ("object" === type || "function" === type)
                    }(value) ? fulfill(promise, value) : handleMaybeThenable(promise, value, getThen(value))
                }
                ...
                var Enumerator = function () {
                    ...
                    return Enumerator.prototype._enumerate = function (input) {
                        ...
                        if (resolve$$1 === resolve$1) {
                            ...
                            if (_then === then && entry._state !== PENDING) this._settledAt(entry._state, i, entry._result); else if ("function" != typeof _then) this._remaining--, this._result[i] = entry; else if (c === Promise$2) {
                ...
                var Promise$2 = function () {
                    function Promise(resolver) {
                        this[PROMISE_ID] = id++, this._result = this._state = void 0, this._subscribers = [], noop !== resolver && ("function" != typeof resolver && function () {
                ...
                return Promise$2.prototype.then = then, Promise$2.all = function (entries) {
                ...
                }, Promise$2.resolve = resolve$1, Promise$2.reject = function (reason) {
                    var promise = new this(noop);
                    ...
                    asap = asapFn
                }, Promise$2._asap = asap, Promise$2.polyfill = function () {
                    var local = void 0;
                ...
                }, Promise$2.Promise = Promise$2, Promise$2.polyfill(), Promise$2
            })
